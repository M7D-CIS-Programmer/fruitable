                    ...
                    <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                        <div class="hero-text">
                            <div class="hero-text-tablecell">
                                ...
                                <div class="hero-btns">
                                    <a href="{{ route('page.shopping') }}" class="boxed-btn">Fruit Collection</a>
                                    <a href="{{ route('page.contact') }}" class="bordered-btn">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10 offset-lg-1 text-center">
                        <div class="hero-text">
                            <div class="hero-text-tablecell">
                                ...
                                <div class="hero-btns">
                                    <a href="{{ route('page.shopping') }}" class="boxed-btn">Visit Shop</a>
                                    <a href="{{ route('page.contact') }}" class="bordered-btn">Contact Us</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 text-center">
                        <div class="single-product-item">
                            <div class="product-image">
                                <a href="{{ route('page.shopping', $item->id) }}"><img src="{{ url($item->imgepath) }}"
                                        alt="" style="max-height: 250px !important;min-height:250px !important"></a>
                            </div>
                            <h3>{{ $item->title }}</h3>
                        </div>
                    </div>
